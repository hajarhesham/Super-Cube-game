public class Player extends AnimatedSprite {
    ...
    public Player(PImage img, float scale) {
        ...
        //moveLeft[2] = loadImage("player_walk_left3.png");
        //moveLeft[3] = loadImage("player_walk_left2.png");
        moveRight = new PImage[2];
        moveRight[0] = loadImage("player_walk_right1.png");
        moveRight[1] = loadImage("player_walk_right2.png");
        //moveRight[2] = loadImage("player_walk_right3.png");
        //moveRight[3] = loadImage("player_walk_right2.png");
